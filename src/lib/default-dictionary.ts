...
export const DEFAULT_THAI_DICTIONARY: DictionaryEntry[] = [
  ...
  { wrong_word: 'วิธีใช้ สี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'วิธีใช้สี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'วิธีใช้ ซี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'วิทีซี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'ไทป์ซี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'ไทป์ ซี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'ไทบซี', correct_word: 'Type-C', category: 'tech' },
  { wrong_word: 'usb แอมป์', correct_word: 'USB-A', category: 'tech' },
  { wrong_word: 'usb แอม', correct_word: 'USB-A', category: 'tech' },
  { wrong_word: 'ยูเอสบี แอมป์', correct_word: 'USB-A', category: 'tech' },
  { wrong_word: 'ยูเอสบี เอ', correct_word: 'USB-A', category: 'tech' },
  { wrong_word: 'ยูเอสบี ซี', correct_word: 'USB-C', category: 'tech' },
  { wrong_word: 'ยูเอสบี ไทป์ซี', correct_word: 'USB Type-C', category: 'tech' },
  { wrong_word: 'ไว้นกลีนสำ', correct_word: 'Lightning สำหรับ', category: 'tech' },
  { wrong_word: 'ไว้นกลีน', correct_word: 'Lightning', category: 'tech' },
  { wrong_word: 'ไว้นกลีนส์', correct_word: 'Lightning', category: 'tech' },
  { wrong_word: 'ไลท์นิ่ง', correct_word: 'Lightning', category: 'tech' },
  { wrong_word: 'ไลนิ่ง', correct_word: 'Lightning', category: 'tech' },
  { wrong_word: 'ไลท์นิ่งส์', correct_word: 'Lightning', category: 'tech' },
  { wrong_word: 'ฟาสชาร์จ', correct_word: 'Fast Charge', category: 'tech' },
  { wrong_word: 'ฟาสต์ชาร์จ', correct_word: 'Fast Charge', category: 'tech' },
  { wrong_word: 'นเกมชร่า', correct_word: 'เล่นเกมชาร์จ', category: 'tech' },
  { wrong_word: 'นเกม', correct_word: 'เล่นเกม', category: 'tech' },
  { wrong_word: 'ชร่า', correct_word: 'ชาร์จ', category: 'tech' },
  { wrong_word: 'เก้าสิบองศา', correct_word: '90 องศา', category: 'tech' },
  { wrong_word: '90องศา', correct_word: '90 องศา', category: 'tech' },
  { wrong_word: 'คิมิโซะ', correct_word: 'Kimiso', category: 'brands' },
