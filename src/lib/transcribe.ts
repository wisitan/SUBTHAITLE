...
export async function transcribeAudio(
  ...
  if (isFreeMode) {
    if (mediaDuration > 125) {
      throw new Error(
        'โหมดใช้งานฟรีรองรับคลิปยาวไม่เกิน 2 นาที กรุณาเลือกโหมด "โควต้าผู้สนับสนุน" เพื่อถอดเสียงคลิปยาวสูงสุด 20 นาที หรือตัดแบ่งคลิปก่อนค่ะ'
      );
    }
  } else if (providerMode === 'credits') {
    if (mediaDuration > 1230) {
      throw new Error(
        'ระบบรองรับคลิปยาวสูงสุดไม่เกิน 20 นาทีต่อคลิป เพื่อความเสถียรและความแม่นยำสูงสุด กรุณาตัดแบ่งคลิปเป็นช่วงไม่เกิน 20 นาทีนะคะ'
      );
    }
