    ...
    if (mode === 'free' || mode === 'groq_free' || mode === 'google_free') {
      ...
      if (clientDuration > 125) {
        return NextResponse.json(
          {
            error:
              'คลิปวิดีโอมีความยาวเกิน 2 นาทีสำหรับโหมดใช้งานฟรี กรุณาเลือกโหมด "โควต้าผู้สนับสนุน" เพื่อถอดเสียงคลิปยาวสูงสุด 20 นาที หรือตัดแบ่งคลิปก่อนค่ะ',
          },
          { status: 400 }
        );
      }
      ...
      // 1. Credits mode duration limit: max 20 minutes (1230s)
      if (clientDuration > 1230) {
        return NextResponse.json(
          {
            error:
              'คลิปวิดีโอมีความยาวเกิน 20 นาทีซึ่งเป็นขีดจำกัดสูงสุดต่อคลิปของระบบ เพื่อความเสถียรและความแม่นยำสูงสุด กรุณาตัดแบ่งคลิปเป็นช่วงไม่เกิน 20 นาทีนะคะ',
          },
          { status: 400 }
        );
      }
