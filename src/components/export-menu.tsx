  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className="px-4.5 py-2.5 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-zinc-950 font-bold text-sm shadow-lg shadow-orange-500/20 flex items-center gap-2 transition-all cursor-pointer"
      >
      ...
      {/* Dropdown Menu Panel */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 max-w-[calc(100vw-32px)] bg-zinc-950/95 backdrop-blur-xl border border-zinc-800 rounded-3xl p-2.5 shadow-2xl z-[999] space-y-1 animate-in fade-in slide-in-from-top-2 duration-150">
          {/* Header Label */}
          <div className="px-3 py-1.5 text-xs font-bold text-zinc-300 uppercase tracking-wider border-b border-zinc-800/80 mb-1">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-orange-500/15 text-orange-400 flex items-center justify-center shrink-0 mt-0.5 group-hover:scale-105 transition-transform">
          ...
          <button
            ...
            className="w-full text-left p-3 rounded-2xl hover:bg-zinc-900 border border-transparent hover:border-zinc-800 transition-all flex items-start gap-3 cursor-pointer group"
          >
            <div className="w-9 h-9 rounded-xl bg-purple-500/15 text-purple-400 flex items-center justify-center shrink-0 mt-0.5 group-hover:scale-105 transition-transform">
          ...
          <button
            ...
            className="w-full text-left p-3 rounded-2xl hover:bg-zinc-900 border border-transparent hover:border-zinc-800 transition-all flex items-start gap-3 cursor-pointer group"
          >
            <div className="w-9 h-9 rounded-xl bg-blue-500/15 text-blue-400 flex items-center justify-center shrink-0 mt-0.5 group-hover:scale-105 transition-transform">
          ...
          <button
            ...
            className="w-full text-left px-3.5 py-2.5 rounded-xl hover:bg-zinc-900 transition-all flex items-center justify-between text-sm text-zinc-200 hover:text-white cursor-pointer"
          >
            <div className="flex items-center gap-2">
              <FileText className="w-4 h-4 text-zinc-400" />
              <span>ซับไตเติล SubRip (.srt)</span>
            </div>
            <span className="text-xs text-zinc-400 font-mono">1-Click</span>
          </button>
