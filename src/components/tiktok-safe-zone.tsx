...
export function TikTokSafeZone({ visible }: TikTokSafeZoneProps) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-30 select-none overflow-hidden font-sans flex flex-col justify-between p-2">
      ...
      {/* 2. Right Action Column (Avatar, Like, Comment, Bookmark, Share, Audio Disc) */}
      <div className="absolute right-1.5 bottom-3 flex flex-col items-center gap-2.5 drop-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[9.5px] font-extrabold text-white tracking-tight">1.2k</span>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[9px] font-bold text-white tracking-tight">88</span>
        </div>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[9.5px] font-extrabold text-white tracking-tight">340</span>
        </div>
      ...
      {/* 3. Bottom Area: Yellow Shopping Basket + Creator Handle + Caption */}
      <div className="w-full flex flex-col gap-1 drop-shadow-[0_2px_4px_rgba(0,0,0,0.95)] pb-0.5">
        ...
        <div className="w-fit max-w-[76%] bg-black/30 backdrop-blur-md border border-white/10 rounded-lg px-2 py-1 flex items-center gap-1.5 shadow-md">
        ...
        <div className="w-[78%] px-0.5 space-y-0.5">
          ...
          <p className="text-[10px] text-white/95 line-clamp-2 leading-tight font-normal">
            พิกัดสินค้ากดในตะกร้าเหลืองมุมซ้ายล่างได้เลยน้า #รีวิว #ของดีบอกต่อ #ป้ายยา
          </p>
        </div>
