      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 pt-0.5">
          <input
            ...
            className="w-full sm:flex-1 px-3.5 py-2.5 rounded-xl bg-[#0f0f18] border border-zinc-700 text-sm text-white placeholder-zinc-500 focus:outline-none focus:border-orange-500 shadow-inner"
            required
          />
          <button
            type="submit"
